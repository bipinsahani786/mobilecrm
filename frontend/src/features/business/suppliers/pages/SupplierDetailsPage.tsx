    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#09090b] text-slate-900 dark:text-slate-200">
      ...
      <div className="relative w-full max-w-[1600px] mx-auto px-4 sm:px-6 py-6 space-y-6 z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/80 dark:bg-[#111118]/80 backdrop-blur-2xl border border-slate-200/80 dark:border-white/10 rounded-2xl p-4 shadow-sm">
          ...
          <div className="flex flex-wrap sm:flex-nowrap gap-2.5 w-full sm:w-auto items-center shrink-0">
            <button 
              onClick={() => setIsEditModalOpen(true)}
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 h-10 px-4 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 hover:bg-amber-100 dark:hover:bg-amber-500/20 text-amber-600 dark:text-amber-400 rounded-xl font-bold text-xs uppercase tracking-wider transition-all shadow-sm whitespace-nowrap cursor-pointer"
            >
              <Edit2 className="w-3.5 h-3.5" /> Edit Supplier
            </button>
            <Button variant="brand" onClick={() => navigate(`/suppliers/${id}/purchases/new`)} className="flex-1 sm:flex-none h-10 px-4 text-xs rounded-xl font-bold uppercase tracking-wider whitespace-nowrap cursor-pointer">
              <Plus className="w-4 h-4 mr-1.5" />
              Add Purchase Bill
            </Button>
            <button 
              onClick={() => navigate(`/suppliers/${id}/purchase-returns/new`)}
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 h-10 px-4 bg-rose-50 dark:bg-rose-500/10 border border-rose-200 dark:border-rose-500/20 hover:bg-rose-100 dark:hover:bg-rose-500/20 text-rose-600 dark:text-rose-400 rounded-xl font-bold text-xs uppercase tracking-wider transition-all shadow-sm whitespace-nowrap cursor-pointer"
            >
        ...
        <div className="bg-white dark:bg-[#09090b] border border-slate-200 dark:border-white/5 rounded-2xl overflow-hidden shadow-sm">
          <div className="flex overflow-x-auto scrollbar-none border-b border-slate-200 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.01]">
            <button
              onClick={() => setActiveTab('purchases')}
              className={`px-6 py-4 text-sm font-bold tracking-wide uppercase transition-colors flex items-center gap-2 relative whitespace-nowrap ${activeTab === 'purchases' ? 'text-primary-600' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
            >
              Purchases
            ...
            <button
              ...
              className={`px-6 py-4 text-sm font-bold tracking-wide uppercase transition-colors flex items-center gap-2 relative whitespace-nowrap ${activeTab === 'payments' ? 'text-primary-600' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
            >
              Payments
            ...
            <button
              ...
              className={`px-6 py-4 text-sm font-bold tracking-wide uppercase transition-colors flex items-center gap-2 relative whitespace-nowrap ${activeTab === 'ledger' ? 'text-primary-600' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
            >
          ...
          <div className="p-0">
                ...
                renderSubComponent={(purchase) => {
                  ...
                  return (
                    <div className="p-4 bg-slate-50/50 dark:bg-[#111118]/50 border-t border-slate-100 dark:border-white/5 shadow-inner">
                      ...
                      <div className="rounded-xl border border-slate-200 dark:border-white/10 overflow-x-auto bg-white dark:bg-[#09090b]">
            ...
            {activeTab === 'ledger' && (
              <div className="space-y-4 printable-ledger">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-between items-start sm:items-center p-4 bg-slate-50 dark:bg-white/[0.01] border border-slate-200 dark:border-white/5 rounded-xl print:hidden">
                   <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
                      <div className="space-y-1">
                        ...
                        <DatePicker value={ledgerStartDate} onChange={setLedgerStartDate} placeholder="Start Date" controlSize="sm" className="w-36" />
                      </div>
                      <div className="space-y-1">
                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-500">End Date</label>
                        <DatePicker value={ledgerEndDate} onChange={setLedgerEndDate} placeholder="End Date" controlSize="sm" className="w-36" />
                      </div>
                   </div>
                ...
                <div className="w-full overflow-x-auto rounded-xl border border-slate-200/80 dark:border-white/10">
